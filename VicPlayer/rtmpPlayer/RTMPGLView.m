...
@protocol RTMPMovieGLRenderer

- (BOOL)isValid;
- (NSString *)fragmentShader;
- (void)resolveUniforms:(GLuint)program;
- (void)setFrame:(RTMPVideoFrame *)frame;
- (BOOL)prepareRender;

@end

@interface RTMPMovieGLRenderer_RGB : NSObject <RTMPMovieGLRenderer> {
...
@implementation RTMPMovieGLRenderer_RGB
...
@interface RTMPMovieGLRenderer_YUV : NSObject <RTMPMovieGLRenderer> {
...
@implementation RTMPMovieGLRenderer_YUV
...
- (void) setFrame:(RTMPVideoFrame *)frame
{
    RTMPVideoFrameYUV *yuvFrame = (RTMPVideoFrameYUV *)frame;
...
@implementation RTMPGLView {
    ...
    id<RTMPMovieGLRenderer> _renderer;
}
            ...
            decoder:(RTMPDecoder *)decoder
{
    ...
    if (self) {
        ...
        if ([decoder setVideoFrameFormat:EnumRTMPVideoFrameTypeYUV]) {
            
            _renderer = [[RTMPMovieGLRenderer_YUV alloc] init];
        } else {
            
            _renderer = [[RTMPMovieGLRenderer_RGB alloc] init];
        }
